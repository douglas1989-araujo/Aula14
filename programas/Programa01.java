...
public class Programa01 {
  public static void main(String[] args) {
    ...
    //System.out.println(isbn);//Se exibir o mesmo q digitei, blz, vi que está OK o problema 1!!

    // 2 - Procurar no vetor o livro informado
    // 2.1 - Percorrer o vetor até o fim ou até achar
    boolean achou = false;
    Livro livroEncontrado = null;
    for (int i = 0; !achou && i < qtdLivros; i++) {
      achou = isbn.equals(livros[i].getIsbn());
